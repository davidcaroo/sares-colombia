...
export interface ApiAllyAlly extends Struct.CollectionTypeSchema {
  collectionName: 'allies';
  info: {
    description: 'Aliados estrat\u00E9gicos que muestran su logo en el sitio';
    displayName: 'Ally';
    pluralName: 'allies';
    singularName: 'ally';
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::ally.ally'> &
      Schema.Attribute.Private;
...
export interface ApiBannerBanner extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Hero banners / sliders';
    displayName: 'Banner';
    pluralName: 'banners';
    singularName: 'banner';
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Productos Havaianas';
    displayName: 'Product';
    pluralName: 'products';
...
export interface ApiRepresentativeRepresentative
  extends Struct.CollectionTypeSchema {
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global site settings and contact info';
