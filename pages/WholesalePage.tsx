        ...
        <div className="max-w-4xl mx-auto bg-gray-50 rounded-2xl p-8 md:p-12 shadow-sm border border-gray-200 mb-20">
          ...
          <form className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-2">Nombre del Negocio / Razón Social</label>
                <input 
                  type="text" 
                  className="w-full rounded-md border-gray-300 shadow-sm focus:border-brand-red focus:ring-brand-red p-3 border bg-white text-gray-900" 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-2">Ubicación (Ciudad y Depto)</label>
                <input 
                  type="text" 
                  className="w-full rounded-md border-gray-300 shadow-sm focus:border-brand-red focus:ring-brand-red p-3 border bg-white text-gray-900" 
              ...
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-2">Tipo de Negocio</label>
                <select className="w-full rounded-md border-gray-300 shadow-sm focus:border-brand-red focus:ring-brand-red p-3 border bg-white text-gray-900">
            ...
            <div className="pt-4 flex justify-center">
              <button 
                type="submit" 
                className="w-full md:w-1/2 bg-brand-red text-white text-lg font-bold px-8 py-4 rounded-lg hover:bg-red-700 transition shadow-lg transform hover:-translate-y-0.5"
              >
                Enviar Solicitud
              </button>
            </div>
